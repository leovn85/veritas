...
pub enum Stat {
    ...
    MaxExtraSpecialSP(f64),
    CurExtraSpecialSP(f64),
    AdditionalBP(f64),
    Attack(f64),
    BaseAttack(f64),
    ...
    MaxStance(f64),
    CurrentStance(f64),
    Level_FinalDamageAddedRatio(f64),
    AllDamageTypeAddedRatio(f64),
    AllDamageReduce(f64),
    BaseDamageMultiRatio(f64),
    ...
    AllDamageTypeResistanceOverrideBase(f64),
    ...
    ElationDamageAddedRatio(f64),
    ElationDamageAddedRatioBase(f64),
    ElationDamageAddedRatioConvert(f64),
    ElationDamageExtraAddedRatio(f64),
    ElationEchoPoint(f64),
    ...
    ExtraAllDamageTypeAddedRatio5(f64),
    ...
    ExtraElementDamageAddedRatio1(f64),
    ExtraHealBase(f64),
    ExtraShieldBase(f64),
    ExtraTotalShieldPower(f64),
    ExtraTotalHealPower(f64),
    ExtraTotalSpeedAddedRatio(f64),
    ExtraInitSP(f64),
    ExtraTotalLuckDamage(f64),
    ExtraTotalLuckChance(f64),
    ExtraBackPowerConvert(f64),
    ExtraFrontPowerConvert(f64),
    ExtraLuckDamageConvert(f64),
    ExtraLuckChanceConvert(f64),
    ExtraHealConvert(f64),
    ExtraShieldConvert(f64),
    ExtraAllDamageReduceConvert(f64),
    ExtraQuantumResonance(f64),
    ExtraTotalAllDamageReduce(f64),
}
