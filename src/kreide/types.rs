...
#[il2cpp_ref_type("RPG.GameCore.BattleEventDataComponent", base(RPG_GameCore_CharacterDataComponent))]
...
#[il2cpp_ref_type("UnityEngine.Application")]
pub struct UnityEngine_Application;
impl UnityEngine_Application {
	#[il2cpp_method(name = "set_targetFrameRate", args = ["int"])]
	pub fn set_target_framerate(fps: i32) {}

	#[il2cpp_method(name = "get_targetFrameRate", args = [])]
	pub fn get_target_framerate() -> i32 {}
}

#[il2cpp_ref_type("UnityEngine.QualitySettings")]
pub struct UnityEngine_QualitySettings;
impl UnityEngine_QualitySettings {
	#[il2cpp_method(name = "set_vSyncCount", args = ["int"])]
	pub fn set_v_sync_count(count: i32) {}

	#[il2cpp_method(name = "get_vSyncCount", args = [])]
